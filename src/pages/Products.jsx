...
const products = [
  { id: 1, category: "irrigation", name: "Drip Irrigation Kit (1 Acre)", description: "Complete drip irrigation system for 1 acre. Includes mainline, drip tapes, fittings and filter.", price: 32000, unit: "kit", stock: 25, image: "https://images.unsplash.com/photo-1563514227147-6d2ff665a6a0?w=600&q=80" },
  { id: 2, category: "irrigation", name: "Sprinkler Irrigation Kit", description: "Overhead sprinkler system for vegetables and nurseries. Covers up to 0.5 acres.", price: 15000, unit: "kit", stock: 20, image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80" },
  ...
  { id: 7, category: "equipment", name: "Pump Sprayer 20L Knapsack", description: "Manual knapsack sprayer with adjustable nozzle. Durable and easy to use for farm chemical application.", price: 3500, unit: "unit", stock: 80, image: "https://images.unsplash.com/photo-1592982537447-6f2a6a0c7c18?w=600&q=80" },
  { id: 8, category: "equipment", name: "Ox-Plough (Disc Plough)", description: "Heavy-duty disc plough for ox-drawn tillage. Suitable for small to medium farms.", price: 28000, unit: "unit", stock: 12, image: "https://images.unsplash.com/photo-1589923158776-cb4485d99fd6?w=600&q=80" },
  ...
  { id: 13, category: "tools", name: "Hand Jembe (Hoe)", description: "Forged steel jembe for digging, weeding and soil preparation. Long wooden handle.", price: 450, unit: "piece", stock: 500, image: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80" },
  ...
  { id: 16, category: "fertilizers", name: "Mavuno Planting Fertilizer", description: "Specifically formulated for Kenyan soils. Enriched with micronutrients for healthy crop establishment.", price: 4500, unit: "50kg bag", stock: 140, image: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=600&q=80" },
  { id: 17, category: "fertilizers", name: "NPK 17:17:17 Fertilizer", description: "Balanced compound fertilizer for vegetables and horticulture crops.", price: 4000, unit: "50kg bag", stock: 160, image: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=600&q=80" },
  ...
  { id: 19, category: "fertilizers", name: "Urea Fertilizer (46% N)", description: "High nitrogen fertilizer for top dressing. Boosts leafy growth and green color.", price: 3600, unit: "50kg bag", stock: 190, image: "https://images.unsplash.com/photo-1523741543316-beb7fc7023d8?w=600&q=80" },
  { id: 20, category: "fertilizers", name: "DAP Fertilizer (Di-Ammonium Phosphate)", description: "Basal fertilizer for planting. 18% N, 46% P. Suitable for all crops.", price: 4200, unit: "50kg bag", stock: 220, image: "https://images.unsplash.com/photo-1592982537447-6f2a6a0c7c18?w=600&q=80" },
  ...
  { id: 23, category: "seeds", name: "Beans (Rosecoco) Seeds", description: "Certified Rosecoco bean seeds. Popular variety with good market demand.", price: 320, unit: "1kg packet", stock: 350, image: "https://images.unsplash.com/photo-1550828484-7cc4c2f32089?w=600&q=80" },
  ...
  { id: 26, category: "seeds", name: "H614D Maize Seeds", description: "Kenya Seed Company H614D hybrid maize, suited for low to mid altitude areas.", price: 950, unit: "2kg bag", stock: 250, image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&q=80" },
];
